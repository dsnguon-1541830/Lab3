...
airports = L.geoJson.ajax("assets/airports.geojson", {
    ...
    pointToLayer: function (feature, latlng) {
        ...
        else { id = 1;} // "Salem Cellular"
        return L.marker(latlng, {icon: L.divIcon({className: 'fa fa-plane marker-color-' + (id + 1).toString() })});
    },
    attribution: 'Airports Data &copy; data.gov | US States &copy; Mike Bostock of D3 | Base Map &copy; CartoDB | Made By Darren Snguon'
}).addTo(mymap);
...
legend.onAdd = function () {
    ...
    div.innerHTML += '<i class="fa fa-plane marker-color-1"></i><p> Contains Air Traffic Control Tower</p>';
    div.innerHTML += '<i class="fa fa-plane marker-color-2"></i><p> No Air Traffic Control</p>';
